...
class header extends moon_com 
{
	function main($argv) 
	{
		...
		if (!isset($_COOKIE[$cookieVar]) || $_COOKIE[$cookieVar] !='h') {
			...
			$res = '<script type="text/javascript">function closeFlashLayer(){var d=new Date();d.setTime(Date.UTC(d.getFullYear(),d.getMonth(),d.getDate(),23,59,59,999)+d.getTimezoneOffset()*60000+1);document.cookie=\''.$cookieVar.'=h; expires=\'+d.toGMTString()+\'; path=/\';document.getElementById(\'bn0902\').style.display=\'none\'}</script><div style="position: fixed; top: 0; right: 50%; margin-right: -505px; width: 1010px; height: 611px; z-index: 9999;" id="bn0902"><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="1010" height="611" id="mymoviename""><param name="movie" value="/img/p770_wonders_layer_banner.swf?clickTAG='.$bgURL.'" /><param name="quality" value="high" /><param name="allowscriptaccess" value="always"><param name="quality" value="high" /><param name="wmode" value="transparent" /><param name="bgcolor" value="transparent" /><embed src="/img/p770_wonders_layer_banner.swf?clickTAG='.$bgURL.'" wmode="transparent" quality="high" bgcolor="transparent" width="1010" height="611" name="mymoviename" allowscriptaccess="always" align="" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object></div>' . $res;
		}
		return $res;

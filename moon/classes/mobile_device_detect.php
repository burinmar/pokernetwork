...
function mobile_device_detect($iphone=true,$ipad=false,$android=true,$opera=true,$blackberry=true,$palm=true,$windows=true,$mobileredirect=false,$desktopredirect=false){
  ...
  switch(true){ // using a switch against the following statements which could return true is more efficient than the previous method of using if statements
    ...
    case (preg_match('/(iris|3g_t|windows ce|opera mobi|windows phone|XBLWP7)/i',$user_agent)); // we find windows mobile in the user agent - the i at the end makes it case insensitive

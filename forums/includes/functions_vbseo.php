...
return
$preurl .
( (VBSEO_BASEDEPTH && defined('VBSEO_PREPROCESSED')) ? VBSEO_REQURL_FULL : '' ).
...
{
$url_script = $topurl . 
(VBSEO_REWRITE_THREADS ? vbseo_thread_url($tmatch[1],1) : 'showthread.'.VBSEO_VB_EXT.'?'.VBSEO_THREADID_URI.'='.$tmatch[1]);
$clear_all_par = true;
}
...
$url_script = vbseo_thread_url($apars[VBSEO_THREADID_URI],
...
&& ($newalt = vbseo_attachment_url($apars['attachmentid'], VBSEO_URL_ATTACHMENT_ALT)))
{
...
$found_object_ids['pic'] = $matches[1];
...
'Search Engine Friendly URLs by vBSEO '.VBSEO_VERSION2_MORE.' &copy;2008, Crawlability, Inc.',
'Content Relevant URLs by vBSEO '.VBSEO_VERSION2_MORE.' &copy;2008, Crawlability, Inc.',
'Search Engine Optimization by vBSEO '.VBSEO_VERSION2_MORE.' &copy;2008, Crawlability, Inc.',
'SEO by vBSEO '.VBSEO_VERSION2_MORE.' &copy;2008, Crawlability, Inc.',
'LinkBacks Enabled by vBSEO '.VBSEO_VERSION2_MORE,
'LinkBacks Enabled by vBSEO '.VBSEO_VERSION2_MORE.' &copy; 2008, Crawlability, Inc.',
);
...
if(!$tmode) $tmode = $bbuserinfo["threadedmode"] ? 'threaded' : '';
if($tmode=='threaded')
{
...
{
$rr = str_replace('[first_post_'.$fp_m[1].'_words]',

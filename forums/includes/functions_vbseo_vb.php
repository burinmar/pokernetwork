...
{
$_thistpl = str_replace($strsearch, preg_replace('#\$\d+#', '', $replacewith), $_thistpl);
}else
if($searchfor[0] == '#')
{
...
LIMIT 1
");
$getnextoldest['seotitle'] = vbseo_filter_replace_text($getnextoldest['title']);
...
"select t.forumid, t.threadid, " . (VBSEO_GET_THREAD_TITLES ? 't.title, ' : '') . "t.replycount, t.lastposter, ".($haslastpostid?"lastpostid, ":"")."lastpost, visible

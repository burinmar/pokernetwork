...
{
vbseo_modify_template('blog_show_entry', '#("\.\(\(\$' . 'categorybits)#is', 
...
'$1 <a href=\\"#comment$response[blogtextid]\"><img src=\\"$stylevar[imagesfolder]/vbseo/anchor.png\\" border=\\"0\\" alt=\\"$vbphrase[vbseo_permalink]\\" class=\\"inlineimg\\" /></a> $2',
0);
...
{
$vmurl = ($_GET['tab'] && ($_GET['tab'] != 'visitor_messaging')) 
? 'member.php?u='.$_GET['u'] : '';
...
'$0 - <a href=\\"'.$vmurl.'\">$vbphrase[vbseo_permalink]</a>',
0);
...
'<a href=\\"#picturecomment$message[commentid]\">$0</a>',
0);
else
if(VBSEO_PERMALINK_ALBUM == 1)
vbseo_modify_template('picturecomment_message', '#message\[time\].*?\)\)\.\\"#s', 
'$0 - <a href=\\"#picturecomment$message[commentid]\">$vbphrase[vbseo_permalink]</a>',
0);
}
if(THIS_SCRIPT == 'group')
{
...
'$0 - <a href=\\"'.$_plink.'\\">$vbphrase[vbseo_permalink]</a>',
0);
}
...
{
global $navbar, $navclass, $HTML, $navbits, $headinclude, $header, 
